			...
			{open && (
				<motion.div
					...
					<motion.div
						ref={modalRef}
						className={cn(
							"md:min-h-[50%] max-h-[90%] max-w-[80%] md:max-w-[60%] bg-white dark:bg-neutral-950 border border-transparent dark:border-neutral-800 md:rounded-2xl relative z-50 flex flex-col flex-1 overflow-hidden",
							className
						)}
						initial={{
							opacity: 0,
...
export const ModalContent = ({
	...
	return (
		<div className={cn("flex flex-col flex-1 p-8 max-h-[400px] md:max-h-none md:p-10", className)}>
			{children}
		</div>
	);
};
