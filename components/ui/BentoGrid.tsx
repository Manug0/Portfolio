				...
				<div
					...
					{id === 6 && (
						<div className="mt-5 relative m-auto">
							...
							<MagicButton
								title={copied ? "Email copiado!" : "Copia mi dirección de correo"}
								icon={<IoCopyOutline />}
								position="left"
								handleClick={handleCopy}
								width="w-68"
								otherClasses="!bg-[#161A31] text-xs md:text-sm whitespace-nowrap"
							/>
						</div>
					)}
				</div>
